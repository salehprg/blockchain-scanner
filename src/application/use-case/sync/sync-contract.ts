import { BlockchainLogReader, Transfer1155SingleLog, Transfer721Log } from "@/infrastructure/blockchain/log-reader";
...
export class SyncContracts {
  ...
  private async fetchSomniaTransferLogsViaApi(
    ...
    if (contractType === "ERC1155") {
      return this.fetchSomniaERC1155Transactions(contractAddress, fromBlock);
    }
    return this.fetchSomniaERC721Transfers(contractAddress, fromBlock);
  }
